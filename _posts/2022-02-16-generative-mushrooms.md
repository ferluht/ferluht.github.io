...
Briefly, the idea behind it is to make some token generator that gives you a unique art object each time you “mint” it (in actuality, call a method in the blockchain which spends some of your money on its execution and also gives some money to the artist). _Definitely, there is some magic in the feeling that your transaction generates a unique object which will be stored into the blockchain forever, isn’t it?_ 
...
<i>Left to right examples of math, procedural and variative artworks. Credits: [ciphrd](https://www.fxhash.xyz/u/ciphrd), [zancan](https://www.fxhash.xyz/u/zancan), [littlesilver](https://www.fxhash.xyz/u/Littlesilver)</i>
</p>
